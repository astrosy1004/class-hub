...
const CATEGORIES = [
  {
    ...
    limit: 30,
    feeds: [
      // "코딩강사" + 채용/구인/모집(느슨한 매칭) - 수강생·참가자·학생 모집 제외, 최근 30일(when:30d).
      // (완전 구문 "강사 채용" + 14일로 좁혔더니 실검색 결과 0건이라 완화함)
      { source: 'Google 뉴스 코딩강사 구인', url: 'https://news.google.com/rss/search?q=%28%22%EC%BD%94%EB%94%A9%EA%B0%95%EC%82%AC%22+OR+%22%EC%BD%94%EB%94%A9+%EA%B0%95%EC%82%AC%22%29+%28%EC%B1%84%EC%9A%A9+OR+%EA%B5%AC%EC%9D%B8+OR+%EB%AA%A8%EC%A7%91%29+-%EC%88%98%EA%B0%95%EC%83%9D+-%EC%B0%B8%EA%B0%80%EC%9E%90+-%ED%95%99%EC%83%9D+when%3A30d&hl=ko&gl=KR&ceid=KR:ko' },
      // 교육청·학교·방과후·늘봄학교 코딩/SW/정보 강사 채용 관련, 최근 30일.
